...
#提取网页信息的正则表达式
    pattern = re.compile('<span class="cont_tit".*?<font class="cont_tit03">(.*?)</font>',re.S)  
...
def main():
    ...
    content_list_new=parse_one_page(html)
    old_path="/root/python3/news/old1.txt"
    new_path="/root/python3/news/new1.txt"
